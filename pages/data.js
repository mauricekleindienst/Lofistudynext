    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <section className={styles.contactSection}>
          ...
          <p>
            <strong>Effective Date:</strong> 01/02/2024
          </p>
          <p>
          ...
          <ul>
            <li>
              Information you provide directly, such as [list specific
              information like name, email address, etc.].
            </li>
            <li>
          ...
          <p>
            ...
            information to third parties unless we provide you with notice and
            obtain your consent.
          </p>
          <p>
          ...
          <p>
            ...
            your personal information. However, please be aware that no method
          ...
          <p>
            <strong>Last updated:</strong> 01/02/2024
          </p>
        </section>
      </main>
