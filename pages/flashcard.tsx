...
import FlashcardComponent from "../components/FlashcardComponent";  // Your FlashcardComponent
...
export default function FlashcardsPage() {
  ...
  useEffect(() => {
    // Randomly select a background video when the component mounts
    ...
    <>
      ...
      <div className={styles.container}>
        <main className={styles.main}>
          {/* Pass the authenticated user's email to FlashcardComponent */}
          {session && session.user?.email && (
            <FlashcardComponent userEmail={session.user.email} />
          )}
        </main>
      </div>
    </>
